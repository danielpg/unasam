...
require_once APP.'/../plugins/alaxos/libs/string_tool.php';
require_once APP.'/../plugins/alaxos/libs/date_tool.php';
require_once APP.'/../plugins/alaxos/libs/array_tool.php';
...
class AlaxosFilterComponent extends Object
{
    ...
    * @var boolean
    */
    private $auto_append_wildcard_characters = false;
