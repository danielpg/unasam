...
<div class="box" style="width:470px;height:470px;border:0px solid black;border-radius:10px">
	...
	<tr>
		...
		<td>
			...
			<?php elseif($recibo['Persona']['tipo']==TESTUDIANTE): ?>
				...
				<?php if( !empty($recibo['Entidad']['facultad']  )): ?>				
				<?php echo $recibo['Persona']['facultad']; ?><br >
				<?php else: ?>
...
<div style="height:100px"></div>
			...
			<div>Recibo <?php echo "N° ".recibo_id($recibo['Recibo']) ?></div>
			...
			<div style="font-size:24px"><?php echo "N° ".recibo_id($recibo['Recibo']); ?></div>
