...
<form method="post" >
	...
	<?php
		...
		echo $this->Form->input('tipo',array("options"=>array(1 => "LISTADO",2 => "CONSOLIDADO",3 => "RECIBOS COMPLETO", 4 => "EFECTIVO - VUELTO", "5" => "DEPOSITOS",10 => "DIARIO")));

		echo $this->Form->input('oficina_id',array("options"=>$oficinas));
