...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css" integrity="sha512-SfTiTlX6kk+qitfevl/7LibUOeJWlt9rbyDn92a1DqWOw9vWG2MFoays0sgObmWazO5BQPiFucnnEAjpAB+/Sw==" crossorigin="anonymous" referrerpolicy="no-referrer" />
	...
	<script type="text/javascript">
		...
		function printIframe(reg,id)
		{
			...
			$("#printframe").attr("src","<?php echo Router::url("/recibos/imp"); ?>/" + reg);
		...
		<div align="center"><table width="1019px"><tr><td><div id="content">
				...
				<tr class="top_table_top">
					<td style="text-align:left">
						<?php echo $html->image("unasam.jpg",array("align"=>"absmiddle")) ?> 
						<span style="color:darkblue;font-size:20px;font-family:Arial black;position:relative;top:6px">| SISTEMA DE CONTROL DE TESORERIA</span>
						
						<span id="box_loading" style="display:none;"><?php echo $html->image('loading_green_trans.gif')?> <?php __('Loading') ?>...</span>
					</td>
					<td >
						<div class="divlogout" style="text-align:right;margin-right:0">
						
								<div style="color:black;font-weight:bold;width:100%;text-align:right;font-size:12px">
								<?php if(in_array(Credentials::get('__credentials.Login.role_id'),array(2,3))): ?> 
								<?php echo Credentials::get('__credentials.Oficina.nombre') ?> |
								<?php endif; ?>
								<?php echo Credentials::get('__credentials.Login.nombres') ?> 
								| <a style="color:#DBA80E;" tabindex="-1" href="<?php echo $html->url(array('controller'=>'authentication','action'=>'logout')) ?>"><?php __("Cerrar Sesi&oacute;n") ?></a>
								</div>
						...
						<td width="100%">
								...
								<li><a href="#" tabindex="-1"><i class="fa fa-database"></i> &nbsp;Definiciones&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a>
									<ul>
										...
										<li><?php echo $this->Html->link(__('Categorias', true), array('controller' => 'categorias', 'action' => 'index'),array('tabindex' => '-1')); ?> </li>
										<li><?php echo $this->Html->link(__('Clasificador', true), array('controller' => 'rubros', 'action' => 'index'),array('tabindex' => '-1')); ?> </li>
										<li><?php echo $this->Html->link(__('Personas', true), array('controller' => 'personas', 'action' => 'index'),array('tabindex' => '-1')); ?> </li>
									</ul>
								</li>
								<?php endif; ?>
								<li><a href="#" tabindex="-1"><i class="fa fa-list"></i> &nbsp;Recibos</a>
									<ul>
										...
										<li><?php echo $this->Html->link(__('Nuevo', true), array('controller' => 'recibos', 'action' => 'add_super'),array('tabindex' => '-1')); ?></li>
										<?php endif; ?>
										<li><?php echo $this->Html->link(__('Extornos', true), array('controller' => 'recibos', 'action' => 'extorno'),array('tabindex' => '-1')); ?></li>
										<li><?php echo $this->Html->link(__('Depositos', true), array('controller' => 'depositos', 'action' => 'index'),array('tabindex' => '-1')); ?></li>
									</ul>	
								</li>
								...
								<li><a href="#" tabindex="-1"><i class="fa fa-money"></i> &nbsp;Precios</a>
									<ul>
										...
										<?php if(Credentials::get("__credentials.Role.codigo")=="admin"): ?>
										<li><?php echo $this->Html->link(__('Nuevo', true), array('controller' => 'precios', 'action' => 'add'),array('tabindex' => '-1')); ?></li>
										<?php endif; ?>
									</ul>	
								</li>
								</li>
